  ...
  */
  ...
  this._collideWithOne = function(type, other, callback) {
    ...
    if (type === 'bounce') {
      ...
      // so our sprite velocities onto that normal (captured in the
...
p5.prototype._warn = function(message) {
  ...
  p5.AxisAlignedBoundingBoxCollider.prototype._getRadiusOnAxis = function(axis) {
    // How to a rect onto an axis:
    // the center-corner vectors for two adjacent corners (cached here)
